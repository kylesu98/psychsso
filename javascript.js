...
Wait_unable2: ["Please stop by the Psychology advising office to discuss the error. <br>We are located at 3305 Tolman.<br>Drop in hours are 9AM - 12PM, 1PM - 4PM.",
            0,
            [],
            [],
            "Wait_no",
...
Phase_2: ["Are you a Transfer Student enrolling for your first semester at UC Berkeley?", 
            2, 
            ["Yes", "No"], 
...
Error_other2:["Please stop by the Psychology advising office to discuss the error. <br>We are located at 3305 Tolman.<br>Drop in hours are 9AM - 12PM, 1PM - 4PM.",
            0,
            [],
            [],
            "Dot_yes",
...
Wait_switch_yes:["Unfortunately, students on the waitlist can't switch sections.<br>Instructions will be sent out to all waitlisted students via email during the second week of instruction on how to switch sections.",
            0,
            [],
            [],
            "Waitlist_yes",
...
Conflict_yes:["Please resolve the time conflict by either dropping the conflicting class or completeing the " + "registrar's form".link("http://registrar.berkeley.edu/registration/enrollment") +" for a time conflict override. You will not be enrolled if your time conflict is unresolved.",
            0,
            [],
            [],
            "Wait_switch_no",
